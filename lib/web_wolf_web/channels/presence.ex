defmodule WebWolfWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule WebWolf.MyChannel do
        use WebWolfWeb, :channel
        alias WebWolf.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :web_wolf,
                        pubsub_server: WebWolf.PubSub
end
